              ...
              <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                ...
                <div className='max-w-3xl mx-auto'>
                  ...
                  <div className='bg-white'>
                    ...
                    <h1 className='text-3xl font-extrabold tracking-tight text-gray-900'>Detalles de las órdenes</h1>
                        ...
                        <div className='space-y-12'>
                          {orders && orders.map((product, index) => (
                            <div key={index}>
                              ...
                              <h1 className='text-3xl font-extrabold tracking-tight text-gray-900'>Order ({index + 1}) </h1>
                              ...
                              >
                                ...
                                <div className='sm:col-span-12 md:col-span-7'>
                                  <dl className='grid grid-cols-1 gap-y-4 border-b py-4 border-gray-200 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10'>
                                    <div>
                                  ...
                                  <p className='font-medium text-gray-900 mt-3 md:mt-10'>
